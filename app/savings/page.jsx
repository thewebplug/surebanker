    ...
    <div className="savings">
      ...
      {open &&   <div className="savings__modal" onClick={handleModalClose}>
        <div className="savings__modal__inner">
          {stage === 2 && <button className="savings__modal__inner__filter-item">{filterItem}</button>}
          ...
          {stage === 2 && <div className="savings__modal__inner__amount">
            <div>NGN</div>
            <input type="text" placeholder="20,000" value={amount} onChange={(e) => setAmount(e.target.value)} />
            </div>}

            {stage === 3 && <input type="text" className="savings__modal__inner__input"
            value={filterItem}
            onChange={(e) => setFilterItem(e.target.value)}
            />}
          <div className="savings__modal__inner__button-group">
            {stage > 1 && <button className="savings__modal__inner__button-group__back"
