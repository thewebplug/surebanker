  ...
  return (
    <div className="surebanker-data">
      ...
      <div className="surebanker-data__tab">
        <div className="surebanker-data__tab__active"
        >Data</div>
        <div
...
<br />
        ...
        <div className="surebanker-data__category__cards">
          <div
            className={
              category === 0 && "surebanker-data__category__cards__active"
            }
          ...
          <div
            className={
              category === 1 && "surebanker-data__category__cards__active"
            }
          ...
          <div
            className={
              category === 2 && "surebanker-data__category__cards__active"
            }
        ...
        <div className="surebanker-data__automate-title">Automate Top-up</div>

        <div
          className={`surebanker-data__automate-switch ${
            automateTopup && `surebanker-data__automate-switch-active`
          }`}
        ...
        <div className="surebanker-data__automate-details">
          From <span>18th Sep 2024</span> to <span>23rd Sep 2024</span>{" "}
          recurring Monthly
        </div>
      ...
      {open && (
        <form className="surebanker-data__otp-modal" onSubmit={handleOtpSubmit}>
          ...
          <button className="surebanker-data__button" type="submit">
        ...
        <div className="surebanker-data__otp-modal">
          <div className="surebanker-data__otp-modal__title">
            ...
            <div>
              ...
              <div>
                This will cancel your next top up by 11th Sept 2024 and others
              </div>
            </div>
          </div>

          <button
            className="surebanker-data__automate-trans-button"
            onClick={() => {
          ...
          <button
            className="surebanker-data__automate-button"
            onClick={() => {
              setAutomateTopup(true);
              setAutomatedOpen(false);
            }}
