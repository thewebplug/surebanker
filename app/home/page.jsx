...
import TransactionPinSuccess from "@/app/components/transaction-pin-success";
import TransactionPinFail from "@/app/components/transaction-pin-fail";
import { useSelector } from "react-redux";
import { getAccountDetails } from "@/app/apis/transactions";
...
<div className="dashboard-main__title__acc-no">
          Wallet ID : {account?.walletId} <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
