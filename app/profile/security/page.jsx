...
import { initiateChangePassword } from "@/app/apis/auth";
...
export default function Fund() {
  ...
  const handleSubmitPassword = async (e) => {
    ...
    if (stage === 1 || stage === 4) {
      if (newPassword !== confirmNewPassword) {
        ...
        const response = await initiateChangePassword(
          password,
          newPassword,
          auth?.token
        );
  ...
  useEffect(() => {
    const otpInputs = document.querySelectorAll(
      ".personal-settings__modal__inner__otp-inputs__input"
    );
  ...
  return (
    <div className="personal-settings">
      ...
      <div
        className="personal-settings__group"
      ...
      >
        ...
        <div>
          ...
          <div className="personal-settings__group__subtitle">
      ...
      {passwordOpen && (
        <div className="personal-settings__modal" onClick={handleToggleClose}>
          {stage === 1 && (
            <form
              className="personal-settings__modal__inner"
            ...
            >
              <div className="personal-settings__modal__inner__title">
                ...
                <div>
                  ...
                  <div>
                    Update your password by providing the old password, or using
              ...
              <input
                type="password"
                className="personal-settings__modal__inner__input"
              ...
              />
              <div
                className="personal-settings__modal__inner__forgot"
                onClick={() => setStage(2)}
              >
                Forgot Old Pin?
              </div>
            ...
            >
              <div className="personal-settings__modal__inner__title">
                ...
                <div>
                  ...
                  <div>
                    Please provide your email below, you will be sent an OTP to
            ...
            >
              <div className="personal-settings__modal__inner__title">
                ...
                <div>
                  ...
                  <div>
                    Provide the OTP sent to your email mu****ak@gmail.com
                  </div>
                </div>
              </div>
              <div className="personal-settings__modal__inner__otp-inputs">
                <input
                  type="text"
                  className="personal-settings__modal__inner__otp-inputs__input"
                  maxLength={1}
                  required
                />
                <input
          ...
          {stage === 1 && (
            ...
            >
              <div className="personal-settings__modal__inner__title">
                ...
                <div>
                  <div>
                    <span>Enter Old Pin</span>
                  </div>
                  <div>
                    Update your Pin by providing the old Pin, or using the
                    forgot Pin option
                  </div>
                </div>
              </div>
              <label
                className="personal-settings__modal__inner__label"
                htmlFor=""
              >
                Old Pin
              </label>
